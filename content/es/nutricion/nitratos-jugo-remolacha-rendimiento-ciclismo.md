---
title: "Nitratos y Jugo de Remolacha: la Evidencia del Óxido Nítrico en Ciclismo"
subtitle: "Un metaanálisis de 47 estudios confirma que la suplementación con nitrato mejora el tiempo hasta el agotamiento un 4-25%, aunque su efecto en contrarreloj es más modesto"
section: "nutricion"
date: "2026-04-03"
author: "Martín Velasco"
tags: ["nitratos", "remolacha", "óxido nítrico", "suplementación", "rendimiento"]
sources:
...
![Jugo de remolacha en vaso, fuente natural concentrada de nitratos inorgánicos para ciclistas](https://images.unsplash.com/photo-1622597467836-f3285f2131b8?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)
...
<ChartBar
  title="Efecto de la dosis de nitrato sobre el rendimiento"
  caption="Fuente: Wylie et al. (2013), J Appl Physiol"
  data={[
    { dosis: "4.2 mmol", reduccion_vo2: 0.3, aumento_tte: 2 },
    { dosis: "8.4 mmol", reduccion_vo2: 1.7, aumento_tte: 14 },
    { dosis: "16.8 mmol", reduccion_vo2: 3.0, aumento_tte: 12 }
  ]}
  xKey="dosis"
  bars={[
    { key: "reduccion_vo2", color: "#0D9488", name: "Reducción VO₂ (%)" },
    { key: "aumento_tte", color: "#7C3AED", name: "Aumento TTE (%)" }
  ]}
  unit="%"
/>
...
<ChartLine
  title="Efecto del nitrato según nivel de entrenamiento"
  caption="Síntesis de múltiples estudios. Adaptado de Jones (2014)"
  data={[
    { nivel: "Sedentarios", mejora_tte: 25, mejora_tt: 3.0 },
    { nivel: "Recreativos", mejora_tte: 14, mejora_tt: 2.7 },
    { nivel: "Entrenados", mejora_tte: 5, mejora_tt: 1.2 },
    { nivel: "Élite", mejora_tte: 1, mejora_tt: 0.2 }
  ]}
  xKey="nivel"
  lines={[
    { key: "mejora_tte", color: "#0D9488", name: "Mejora TTE (%)" },
    { key: "mejora_tt", color: "#7C3AED", name: "Mejora TT (%)" }
  ]}
  unit="%"
/>
