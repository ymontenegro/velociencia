---
title: "Proteína entre etapas: cuánto, cuándo y cómo en las tres semanas de una gran vuelta"
subtitle: "La diferencia entre 1.8 y 2.2 g/kg/día no está en la primera etapa sino en la tercera semana, cuando el déficit acumulado empieza a cobrar factura"
section: "nutricion"
date: "2026-05-15"
author: "Martín Velasco"
tags: ["proteína", "recuperación", "grandes vueltas", "caseína", "MPS", "síntesis proteica", "etapas consecutivas", "leucina", "nutrición ciclismo"]
excerpt: "En una gran vuelta, el balance nitrogenado negativo después de cada etapa es el enemigo silencioso. Los datos muestran cuánta proteína, cuándo y en qué tomas."
...
<ChartBar
  title="Distribución proteica diaria recomendada — ciclista de 70 kg en etapa de montaña"
  caption="Basado en Witard et al. (2025) y Jäger et al. (2017). Valores aproximados según contexto de gran vuelta."
  data={[
    { toma: "Desayuno (3-4h antes)", gramos: 35 },
    { toma: "A bordo (mitad de etapa)", gramos: 12 },
    { toma: "Post-etapa (<30 min)", gramos: 30 },
    { toma: "Cena principal", gramos: 50 },
    { toma: "Pre-sueño (caseína)", gramos: 40 },
  ]}
  xKey="toma"
  bars={[{ key: "gramos", color: "#0D9488", name: "Proteína (g)" }]}
  unit=" g"
  layout="vertical"
/>
...
<ChartBar
  title="Rendimiento al día siguiente según protocolo de recuperación (Sollie et al., 2018)"
  caption="Ocho ciclistas de élite. CHO: 1.2 g/kg/h solo. CHO+PRO: 0.8 g CHO + 0.4 g PRO /kg/h durante 2h post-ejercicio."
  data={[
    { protocolo: "Solo CHO", tt_mejora: 0, sprint_mejora: 0 },
    { protocolo: "CHO + Proteína", tt_mejora: 8.5, sprint_mejora: 3.7 },
  ]}
  xKey="protocolo"
  bars={[
    { key: "tt_mejora", color: "#0D9488", name: "Mejora TT 26 km (%)" },
    { key: "sprint_mejora", color: "#7C3AED", name: "Mejora sprint 10s (%)" },
  ]}
  unit="%"
/>
