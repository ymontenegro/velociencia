---
title: "Antocianinas y cereza ácida Montmorency: la recuperación que mide 4.6% en una contrarreloj"
subtitle: "Un meta-análisis de 39 estudios y cuatro ensayos específicos en ciclistas confirman que el jugo concentrado de cereza Montmorency reduce la creatina quinasa, la IL-6 y el DOMS — pero también tiene un timing óptimo, un formato que importa y una advertencia para bloques de adaptación"
section: "nutricion"
date: "2026-05-19"
author: "Martín Velasco"
tags: ["antocianinas", "cereza Montmorency", "recuperación", "polifenoles", "inflamación", "ciclismo", "suplementación", "daño muscular"]
excerpt: "Kimble, Jones y Howatson analizaron 39 estudios en 2023 y encontraron que los alimentos ricos en antocianinas reducen la creatina quinasa a las 48 horas (Hedges g = -0.31) y mejoran la fuerza en todos los puntos temporales post-ejercicio. En ciclismo, Bell et al. y Morgan et al. documentaron menores marcadores inflamatorios durante tres días de ciclismo estocástico y una mejora del 4.6% en una contrarreloj de 15 km. El protocolo funciona — pero hay momentos específicos en el calendario de entrenamiento donde conviene evitarlo."
...
sources:
  ...
  - title: "Tart cherry concentrate does not enhance muscle protein synthesis response to exercise and protein in healthy older men"
    ...
    type: pubmed
translationOf: "anthocyanins-tart-cherry-recovery-cycling"
---
...
<ChartBar
  title="Tamaños de efecto en recuperación con antocianinas (Kimble et al., 2023)"
  caption="Meta-análisis de 39 estudios. Hedges g: valores negativos indican reducción (favorable para CK, DOMS); valores positivos indican aumento (favorable para fuerza, potencia, capacidad antioxidante). Fuente: PMID 34402657."
  layout="vertical"
  data={[
    { marcador: "Capacidad antioxidante (0h)", g: 0.56 },
    { marcador: "Fuerza (48h)", g: 0.67 },
    { marcador: "Fuerza (24h)", g: 0.62 },
    { marcador: "Potencia (48h)", g: 0.57 },
    { marcador: "Potencia (24h)", g: 0.62 },
    { marcador: "DOMS (24h)", g: -0.23 },
    { marcador: "CK (48h)", g: -0.31 },
    { marcador: "PCR (0h)", g: -0.24 },
  ]}
  xKey="marcador"
...
<ChartLine
  title="Evolución del rendimiento en contrarreloj de 15 km según timing de suplementación"
  caption="Tiempo en segundos (menor = mejor). Basado en Wangdi et al. (2024), PMID 39213288. Solo grupo de ciclistas entrenados (n=10)."
  data={[
    { condicion: "Sin supl.", tiempo: 1497 },
    { condicion: "30 min antes", tiempo: 1490 },
    { condicion: "90 min antes", tiempo: 1467 },
    { condicion: "150 min antes", tiempo: 1483 },
  ]}
  xKey="condicion"
  lines={[
    { key: "tiempo", color: "#0D9488", name: "Tiempo TT 15 km (s)" },
  ]}
  unit=" s"
/>
