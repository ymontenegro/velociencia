---
title: "Cetonas exógenas en ciclismo: el suplemento de 30 dólares que no mejora tu contrarreloj"
subtitle: "Un meta-análisis de 8 ensayos controlados en IJSNEM (2022) encontró que los ésteres de cetona no mejoran el rendimiento de resistencia (Hedges g = 0.136, p = .419). La señal real está en la recuperación y en los bloques de sobrecarga"
section: "nutricion"
date: "2026-05-11"
author: "Martín Velasco"
tags: ["cetonas exógenas", "beta-hidroxibutirato", "BHB", "éster de cetona", "recuperación", "sobreentrenamiento", "ciclismo", "suplementación"]
excerpt: "Los ésteres de cetona no mejoran el rendimiento en contrarreloj según el meta-análisis más completo disponible. Pero en recuperación post-ejercicio y bloques de sobrecarga, la evidencia de Poffé et al. es convincente: 15% más carga sostenida en tres semanas y 40% más capilarización muscular. Por eso los equipos WorldTour los usan después de la etapa, no antes."
...
<ChartBar
  title="Efectos en rendimiento (contrarreloj): resumen de estudios clave"
  caption="Dirección del efecto de los ésteres de cetona en TT ciclista. Positivo = mejora; Negativo = deterioro; Neutro = sin diferencia significativa."
  layout="vertical"
  data={[
    { estudio: "Cox et al. 2016", efecto: 2 },
    { estudio: "Leckey et al. 2017", efecto: -2 },
    { estudio: "Poffé et al. 2020 (carrera sim.)", efecto: 0 },
    { estudio: "Poffé et al. 2021 (KE+bic.)", efecto: 1 },
    { estudio: "Brooks et al. 2022 (meta)", efecto: 0 }
  ]}
  xKey="estudio"
  bars={[{ key: "efecto", color: "#0D9488", name: "Efecto estimado (%)" }]}
  unit="%"
/>
...
<ChartBar
  title="Carga de entrenamiento sostenida en semana 3: KE vs. Control"
  caption="Fuente: Poffé et al., J Physiol 2019 (PMID: 31039280). Bloque de 3 semanas de sobrecarga."
  data={[
    { grupo: "Placebo (CON)", potencia: 100 },
    { grupo: "Éster de cetona (KE)", potencia: 115 }
  ]}
  xKey="grupo"
  bars={[{ key: "potencia", color: "#0D9488", name: "Potencia relativa (% respecto a semana 1)" }]}
  unit="%"
/>
