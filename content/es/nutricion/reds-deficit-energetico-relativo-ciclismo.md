---
title: "REDs: el lado oscuro de comer poco para subir rápido"
subtitle: "El consenso del COI de 2023 convirtió el déficit energético en un espectro; en ciclistas de élite avanzados, hasta el 64 % ya arrastra baja densidad ósea en la columna."
section: "nutricion"
date: "2026-05-30"
author: "Martín Velasco"
tags: ["REDs", "disponibilidad energética", "salud ósea", "nutrición ciclismo", "rendimiento", "déficit energético"]
...
<ChartBar
  title="Prevalencia de baja densidad mineral ósea lumbar en ciclistas de élite"
  caption="Fuente: Hilkens et al. (2023), Medicine & Science in Sports & Exercise"
  data={[
    { grupo: "Hombres, inicio de carrera", valor: 27 },
    { grupo: "Mujeres", valor: 45 },
    { grupo: "Hombres, carrera avanzada", valor: 64 }
  ]}
  xKey="grupo"
  layout="vertical"
  bars={[{ key: "valor", color: "#0D9488", name: "Baja DMO lumbar" }]}
  unit=" %"
/>
