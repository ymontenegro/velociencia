---
title: "Creatina en Ciclismo: Evidencia, Dosis y Cuándo Tiene Sentido Usarla"
subtitle: "Un meta-análisis de 14 estudios muestra que la creatina aumenta la potencia media en sprints repetidos un 7.5%, pero no mejora el rendimiento en estado estable"
section: "nutricion"
date: "2026-03-30"
author: "Martín Velasco"
tags: ["creatina", "suplementación", "rendimiento", "sprints", "ciclismo", "recuperación", "ergogénico"]
sources:
...
![Ciclistas en pelotón durante una carrera, donde los sprints y ataques repetidos dependen del sistema de fosfocreatina](https://images.unsplash.com/photo-1517649763962-0c623066013b?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)
...
<ChartBar
  title="Efecto de la creatina en sprints repetidos (Glaister & Rhodes, 2022)"
  caption="Fuente: PMID 36041731. Tamaño de efecto (δ) para cada variable."
  data={[
    { variable: "Potencia media", efecto: 0.61 },
    { variable: "Potencia pico", efecto: 0.41 },
    { variable: "Índice de fatiga", efecto: 0.08 }
  ]}
  xKey="variable"
  bars={[{ key: "efecto", color: "#0D9488", name: "Tamaño de efecto (δ)" }]}
  unit=""
/>
...
![Suplementos deportivos en polvo, la forma más común de consumir creatina monohidrato](https://images.unsplash.com/photo-1594882645126-14020914d58d?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)
...
<ChartBar
  title="Seguridad renal de la creatina: meta-análisis de De Souza e Silva et al. (2019)"
  caption="Fuente: PMID 31375416. Cambio en marcadores renales con creatina vs. placebo."
  data={[
    { marcador: "Creatinina sérica", cambio: 0.05 },
    { marcador: "Urea plasmática", cambio: 0.02 },
    { marcador: "Tasa filtración glomerular", cambio: -0.01 }
  ]}
  xKey="marcador"
  bars={[{ key: "cambio", color: "#0D9488", name: "Diferencia vs. placebo" }]}
  unit=" (no significativo)"
/>
