---
title: "EPA y DHA en ciclismo: inflamación, frecuencia cardiaca y la medida que casi ningún atleta alcanza"
subtitle: "Solo 1 de 106 atletas de élite tenía un Omega-3 Index dentro del rango recomendado — los datos muestran por qué eso importa sobre el tapete de rodillos y en carrera"
section: "nutricion"
date: "2026-05-06"
author: "Martín Velasco"
tags: ["omega-3", "EPA", "DHA", "recuperación", "inflamación", "Omega-3 Index", "ciclismo", "suplementación"]
excerpt: "Solo 1 de 106 atletas de élite alemanes alcanzó el Omega-3 Index recomendado del 8%. Los ciclistas muestran reducciones del costo de oxígeno y frecuencia cardiaca con EPA y DHA."
...
<ChartBar
  title="Omega-3 Index: atletas antes vs. después de suplementación vs. objetivo"
  caption="Basado en Peoples/Hingley et al. (2017) y von Schacky et al. (2014). Objetivo según ISSN (2025)."
  data={[
    { grupo: "Atletas élite (basal)", indice: 5.0 },
    { grupo: "Ciclistas entrenados (basal)", indice: 4.5 },
    { grupo: "Ciclistas tras 8 semanas DHA", indice: 6.3 },
    { grupo: "Objetivo mínimo recomendado", indice: 8.0 },
    { grupo: "Objetivo óptimo atletas", indice: 9.5 },
  ]}
  xKey="grupo"
  bars={[{ key: "indice", color: "#0D9488", name: "Omega-3 Index (%)" }]}
  unit="%"
  layout="vertical"
/>
...
<ChartLine
  title="Omega-3 Index esperado durante 8 semanas de suplementación (2 g EPA+DHA/día)"
  caption="Curva orientativa basada en Peoples/Hingley et al. (2017) y datos de la literatura. Línea de referencia en 8% = objetivo mínimo para atletas."
  data={[
    { semana: "Semana 0", indice: 4.7 },
    { semana: "Semana 2", indice: 5.1 },
    { semana: "Semana 4", indice: 5.6 },
    { semana: "Semana 6", indice: 6.0 },
    { semana: "Semana 8", indice: 6.3 },
    { semana: "Semana 12", indice: 7.0 },
    { semana: "Semana 16", indice: 7.7 },
  ]}
  xKey="semana"
  lines={[
    { key: "indice", color: "#0D9488", name: "Omega-3 Index (%)" },
  ]}
  unit="%"
/>
