---
title: "Beta-alanina y Rendimiento en Ciclismo: Evidencia, Dosis y Aplicación Práctica"
subtitle: "La carnosina muscular actúa como buffer de iones H+ y mejora el rendimiento en esfuerzos de 1 a 4 minutos"
section: "nutricion"
date: "2026-03-23"
author: "Martín Velasco"
tags: ["beta-alanina", "carnosina", "ergogénico", "ciclismo", "suplementación"]
sources:
  ...
  - title: "International Society of Sports Nutrition position stand: Beta-Alanine"
    ...
    type: pubmed
  - title: "β-alanine supplementation to improve exercise capacity and performance: a systematic review and meta-analysis"
...
Para esfuerzos más cortos de 60 segundos, la acidosis no alcanza a ser el factor determinante del rendimiento. Para esfuerzos más largos de 4 minutos, el sistema aeróbico asume una proporción creciente de la demanda energética y la contribución del buffer de carnosina se diluye. Hobson et al. reportaron una mejora media del 2,85% y un tamaño del efecto mediano de 0.374 en el rango óptimo. Saunders et al. (2017), en un metaanálisis posterior de 40 estudios publicado en *British Journal of Sports Medicine*, calcularon un tamaño del efecto global de 0.18 (IC 95%: 0.08–0.28): una mejora modesta pero estadísticamente consistente. En ciclismo, esa mejora puede representar la diferencia entre aguantar un ataque o descolgarse del grupo en los últimos 500 metros de un puerto.
...
![Suplemento deportivo en polvo con dosificador sobre superficie clara](https://images.unsplash.com/photo-1704650311974-8ce378f0e8b0?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)
...
Tobias y colaboradores publicaron en 2013 en *Amino Acids* un estudio que evaluó la combinación de beta-alanina con bicarbonato de sodio en ejercicio de alta intensidad. La lógica fisiológica es directa: la carnosina actúa como buffer intracelular y el bicarbonato como buffer extracelular. Combinados, atacan la acidosis desde ambos frentes.
