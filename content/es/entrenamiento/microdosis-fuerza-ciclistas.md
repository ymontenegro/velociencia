---
title: "Microdosis de Fuerza para Ciclistas: La Estrategia que Lleva el Gimnasio a los Días de Carrera"
subtitle: "Sesiones de 8 a 12 minutos de trabajo real ejecutadas cinco veces a la semana acumulan el mismo estímulo neuromuscular que dos sesiones largas sin el coste de recuperación que las hace incompatibles con la temporada"
section: "entrenamiento"
date: "2026-05-11"
author: "Tomás Herrera"
tags: ["fuerza", "microdosis", "temporada competitiva", "economía de pedaleo", "hip thrust", "sentadilla", "entrenamiento concurrente", "periodización"]
sources:
...
<ChartBar
  title="Distribución del estímulo de fuerza: modelo tradicional vs. microdosis"
  caption="Mismo volumen semanal total (≈15 series), distribución radicalmente diferente. Basado en Afonso et al. (2022)"
  data={[
    { dia: "Lun", tradicional: 0, microdosis: 3 },
    { dia: "Mar", tradicional: 8, microdosis: 3 },
    { dia: "Mié", tradicional: 0, microdosis: 3 },
    { dia: "Jue", tradicional: 7, microdosis: 3 },
    { dia: "Vie", tradicional: 0, microdosis: 3 },
    { dia: "Sáb", tradicional: 0, microdosis: 0 },
    { dia: "Dom", tradicional: 0, microdosis: 3 },
  ]}
  xKey="dia"
  bars={[
    { key: "tradicional", color: "#94A3B8", name: "Tradicional (2×/sem)" },
    { key: "microdosis", color: "#0891B2", name: "Microdosis (5×/sem)" },
  ]}
  unit=" series"
/>
