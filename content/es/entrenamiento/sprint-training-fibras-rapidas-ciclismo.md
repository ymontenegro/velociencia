---
title: "Sprint Training para Ciclistas: Cómo Desarrollar las Fibras Rápidas sin Destruir la Base Aeróbica"
subtitle: "Seis segundos al máximo absoluto, cuatro minutos de recuperación, repetido ocho veces: el protocolo que aumenta la potencia pico un 4,7% en ciclistas de competición sin comprometer las adaptaciones aeróbicas acumuladas"
section: "entrenamiento"
date: "2026-05-13"
author: "Tomás Herrera"
tags: ["sprint", "fibras rápidas", "potencia pico", "fosfocreatina", "entrenamiento anaeróbico", "entrenamiento concurrente", "Rønnestad"]
sources:
...
<ChartBar
  title="Sprint training vs. fuerza pesada: mejoras en tests de potencia (6 semanas)"
  caption="n=28 ciclistas competitivos. Kristoffersen, Sandbakk, Rønnestad & Gundersen (2019), Frontiers in Physiology"
  data={[
    { test: "6s pico (fresco)", sst: 4.7, hst: 1.1 },
    { test: "6s pico (fatiga)", sst: 6.1, hst: 1.8 },
    { test: "30s media", sst: 3.7, hst: 1.3 },
    { test: "55m sprint", sst: 4.3, hst: 0.2 },
  ]}
  xKey="test"
  bars={[
    { key: "sst", color: "#0891B2", name: "Sprint training (SST)" },
    { key: "hst", color: "#7C3AED", name: "Fuerza pesada (HST)" },
  ]}
  layout="vertical"
  unit="%"
/>
