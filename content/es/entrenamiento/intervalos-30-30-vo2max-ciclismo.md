---
title: "Intervalos 30/30: La Metodología Noruega que Maximiza el Tiempo en VO2max"
subtitle: "Tres bloques de 13 repeticiones de 30 segundos acumulan más tiempo cardiovascular al límite que cuatro series de cinco minutos, con menor percepción de esfuerzo"
section: "entrenamiento"
date: "2026-04-24"
author: "Tomás Herrera"
tags: ["intervalos", "VO2max", "30/30", "Ronnestad", "intensidad", "potencia", "HIIT", "ciclismo"]
excerpt: "Bent Rønnestad demostró que tres bloques de 13 repeticiones 30/30 mejoran el VO2max un 5,7% frente al 2,6% de los intervalos largos. El mecanismo es tan elegante como contraintuitivo: durante los 30 segundos suaves, el consumo de oxígeno no baja al ritmo del lactato sanguíneo."
...
sources:
  ...
  - title: "Superior Physiological Adaptations After a Microcycle of Short Intervals Versus Long Intervals in Cyclists"
    ...
    type: pubmed
translationOf: "30-30-intervals-vo2max-cycling"
---
...
<ChartBar
  title="Tiempo acumulado ≥90% VO2max por protocolo (sesión típica)"
  caption="Estimado a partir de Rønnestad et al. (2020) y Billat et al. (2000)"
  data={[
    { protocolo: "3×13×30/15", minutos: 11.8 },
    { protocolo: "4×5 min", minutos: 8.2 },
    { protocolo: "3×9×30/30", minutos: 9.1 },
    { protocolo: "4×4 min", minutos: 7.6 },
  ]}
  xKey="protocolo"
  bars={[
...
<ChartLine
  ...
  caption="Protocolo Rønnestad adaptado para ciclistas intermedios y avanzados"
  data={[
    { semana: "S1", repeticiones: 9 },
    { semana: "S2", repeticiones: 10 },
    { semana: "S3", repeticiones: 11 },
    { semana: "S4", repeticiones: 13 },
    { semana: "S5", repeticiones: 13 },
    { semana: "S6", repeticiones: 9 },
  ]}
  xKey="semana"
  lines={[
    { key: "repeticiones", color: "#0891B2", name: "Repeticiones por serie" },
  ]}
  unit=" rep"
/>
