---
title: "Genética y Respuesta al Entrenamiento: Por Qué Tu Compañero Mejora Más Con el Mismo Plan"
subtitle: "Un panel de 21 variantes genéticas explica el 49% de la variabilidad en las ganancias de VO2max tras 20 semanas de entrenamiento idéntico"
section: "ciencia"
date: "2026-04-06"
author: "Sofía Müller"
tags: ["genética", "ACTN3", "ACE", "respuesta al entrenamiento", "VO2max", "personalización"]
sources:
...
![Representación de ADN y estructura molecular en contexto de investigación genómica](https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)
...
<ChartBar
  title="Distribución de ganancias de VO2max en el estudio HERITAGE"
  caption="Fuente: Bouchard et al. (1999), J Appl Physiol"
  data={[
    { rango: "<100", participantes: 38 },
    { rango: "100-200", participantes: 62 },
    { rango: "200-300", participantes: 88 },
    { rango: "300-400", participantes: 96 },
    { rango: "400-500", participantes: 78 },
    { rango: "500-600", participantes: 52 },
    { rango: "600-800", participantes: 42 },
    { rango: ">800", participantes: 25 }
  ]}
  xKey="rango"
  bars={[{ key: "participantes", color: "#7C3AED", name: "Participantes" }]}
  unit=" personas"
/>
...
![Ciclistas entrenando en grupo en carretera abierta](https://images.unsplash.com/photo-1517649763962-0c623066013b?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)
...
<ChartLine
  title="Ganancias de VO2max según perfil genético (HERITAGE)"
  caption="Fuente: Bouchard et al. (2011), J Appl Physiol"
  data={[
    { snps: "≤9", ganancia: 221 },
    { snps: "10-12", ganancia: 320 },
    { snps: "13-15", ganancia: 415 },
    { snps: "16-18", ganancia: 510 },
    { snps: "≥19", ganancia: 604 }
  ]}
  xKey="snps"
  lines={[
    { key: "ganancia", color: "#7C3AED", name: "Ganancia media VO2max" }
  ]}
  unit=" ml/min"
/>
...
![Ciclista solitario en carretera durante entrenamiento con paisaje abierto](https://images.unsplash.com/photo-1596558450268-9c27524ba856?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)
