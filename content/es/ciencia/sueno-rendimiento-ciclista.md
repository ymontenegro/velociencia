...
date: "2026-03-30"
author: "Sofía Müller"
tags: ["sueño", "recuperación", "rendimiento", "fisiología", "descanso", "hormona de crecimiento", "siestas"]
sources:
...
![Ciclista descansando tras un entrenamiento](https://images.unsplash.com/photo-1531353826977-0941b4779a1c?w=1200&q=80&fit=crop&crop=entropy&fm=webp&auto=format,compress)
...
<ChartBar
  title="Distribución de hormona de crecimiento según fase del sueño"
  caption="Adaptado de Halson, 2014 y datos de investigación UC Berkeley 2025"
  data={[
    { fase: "Sueño profundo (N3)", porcentaje: 60 },
    { fase: "Sueño REM", porcentaje: 20 },
    { fase: "Sueño ligero (N1-N2)", porcentaje: 12 },
    { fase: "Vigilia", porcentaje: 8 }
  ]}
  xKey="fase"
  bars={[{ key: "porcentaje", color: "#7C3AED", name: "% de GH liberada" }]}
  layout="vertical"
  unit="%"
/>
...
<ChartLine
  title="Efecto de la extensión de sueño sobre el rendimiento (Mah et al., 2011)"
  caption="Fuente: Mah et al., 2011, Sleep, PMID: 21731144"
  data={[
    { x: "Semana 0", sprint: 16.2, tiros_libres: 73.6 },
    { x: "Semana 2", sprint: 15.9, tiros_libres: 76.8 },
    { x: "Semana 4", sprint: 15.7, tiros_libres: 79.5 },
    { x: "Semana 6", sprint: 15.5, tiros_libres: 82.6 }
  ]}
  xKey="x"
  lines={[
    { key: "sprint", color: "#7C3AED", name: "Sprint (seg)" },
    { key: "tiros_libres", color: "#0891B2", name: "Tiros libres (%)" }
  ]}
  unit=""
/>
...
![Habitación de hotel oscura preparada para descanso](https://images.unsplash.com/photo-1540518614846-7eded433c457?w=1200&q=80&fit=crop&crop=entropy&fm=webp&auto=format,compress)
...
<ChartBar
  title="Impacto de la privación de sueño en el rendimiento ciclista"
  caption="Datos compilados de Roberts et al. (2019) y Dean et al. (2023)"
  data={[
    { metrica: "Potencia contrarreloj 20min", caida: 7 },
    { metrica: "Potencia pico sprint 6s", caida: 7.3 },
    { metrica: "Tiempo contrarreloj", caida: 10 },
    { metrica: "Tiempo de reacción", caida: 8 }
  ]}
  xKey="metrica"
  bars={[{ key: "caida", color: "#7C3AED", name: "% de caída" }]}
  layout="vertical"
  unit="%"
/>
