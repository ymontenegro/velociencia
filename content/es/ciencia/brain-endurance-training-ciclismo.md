---
title: "Brain Endurance Training: entrenar la cabeza para pedalear más lejos"
subtitle: "En una prueba de resistencia, añadir tareas cognitivas agotadoras al entrenamiento mejoró el aguante un 24% frente al 12% del físico solo; en ciclistas, mejoró la contrarreloj de 20 minutos y bajó el esfuerzo percibido."
section: "ciencia"
date: "2026-05-30"
author: "Sofía Müller"
tags: ["fatiga mental", "neurociencia del esfuerzo", "RPE", "brain endurance training", "rendimiento"]
...
| Grupo | Mejora de resistencia |
|-------|----------------------|
| Brain Endurance Training | +24% |
| Solo entrenamiento físico | +12% |

<ChartBar
  title="Mejora de la resistencia tras 5 semanas (Dallaway et al., 2023)"
  caption="Fuente: Dallaway et al., European Journal of Sport Science (2023)"
  data={[{ grupo: "BET (cognitivo + físico)", mejora: 24 }, { grupo: "Solo físico", mejora: 12 }]}
  xKey="grupo"
  bars={[{ key: "mejora", color: "#7C3AED", name: "Mejora de resistencia" }]}
  unit=" %"
/>
