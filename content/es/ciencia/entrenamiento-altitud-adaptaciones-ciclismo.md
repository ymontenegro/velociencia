---
title: "Entrenamiento en Altitud: Qué Dice la Ciencia sobre Vivir Arriba y Entrenar Abajo"
subtitle: "El modelo Live High-Train Low aumenta la masa de hemoglobina un 3.5% en tres semanas, pero la respuesta individual varía más de lo que se creía"
section: "ciencia"
date: "2026-04-03"
author: "Sofía Müller"
tags: ["altitud", "hipoxia", "eritropoyetina", "live-high-train-low", "rendimiento", "hemoglobina", "VO2max"]
sources:
...
<ChartBar
  title="Mejora en tiempo de 5 km por grupo (Levine & Stray-Gundersen, 1997)"
  caption="Fuente: Levine & Stray-Gundersen, J Appl Physiol, 1997"
  data={[
    { grupo: "High-Low", mejora: 13.4 },
    { grupo: "High-High", mejora: 1.2 },
    { grupo: "Low-Low", mejora: 2.0 }
  ]}
  xKey="grupo"
  bars={[{ key: "mejora", color: "#7C3AED", name: "Mejora" }]}
  unit=" segundos"
/>
...
<ChartArea
  title="Zona óptima de altitud para el modelo LHTL"
  caption="Fuente: Chapman et al., J Appl Physiol, 2014"
  data={[
    { altitud: "1500m", beneficio: 10 },
    { altitud: "1780m", beneficio: 25 },
    { altitud: "2000m", beneficio: 65 },
    { altitud: "2085m", beneficio: 85 },
    { altitud: "2250m", beneficio: 90 },
    { altitud: "2454m", beneficio: 88 },
    { altitud: "2600m", beneficio: 70 },
    { altitud: "2800m", beneficio: 40 },
    { altitud: "3000m", beneficio: 20 }
  ]}
  xKey="altitud"
  areas={[{ key: "beneficio", color: "#7C3AED", name: "Beneficio relativo" }]}
  unit="%"
/>
