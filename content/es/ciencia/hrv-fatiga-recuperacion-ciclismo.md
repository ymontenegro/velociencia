---
title: "HRV en Ciclismo: Lo Que Tu Corazón Dice Sobre Tu Fatiga Antes de Que Tú Lo Sepas"
subtitle: "Un coeficiente de variación del LnRMSSD por encima del 10% puede indicar sobrecarga acumulada"
section: "ciencia"
date: "2026-03-23"
author: "Sofía Müller"
tags: ["HRV", "variabilidad cardíaca", "recuperación", "fatiga", "monitorización"]
sources:
...
![Pantalla de monitorización mostrando datos de frecuencia cardíaca y métricas de salud](https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)

## Cómo medir la HRV sin arruinar los datos

El protocolo de medición condiciona la calidad de los datos tanto como el sensor que se use. La recomendación estándar es realizar la medición cada mañana al despertar, en posición supina, durante un período mínimo de un minuto y óptimamente de cinco minutos. La consistencia importa más que la duración: Esco y Flatt (2014, PMID 25177179) demostraron en *Journal of Sports Science and Medicine* que mediciones ultra-cortas de un minuto, tras un breve periodo de estabilización, producen valores de LnRMSSD comparables con registros de cinco minutos, siempre que se mantenga la misma posición y hora.
...
La validez de los datos de HRV depende directamente del sensor. Las cintas de pecho con detección de intervalos R-R, como la Polar H10 y la Garmin HRM-Pro Plus, capturan la señal eléctrica cardíaca a través de electrodos y producen datos comparables a los de un electrocardiograma clínico. Schaffarczyk et al. (2022) validaron la Polar H10 en *Sensors* y encontraron una concordancia excelente con registros de ECG de referencia tanto en reposo como durante ejercicio incremental.
...
![Reloj deportivo en la muñeca mostrando datos de actividad y frecuencia cardíaca](https://images.unsplash.com/photo-1670404160620-a3a86428560e?w=900&q=75&fit=crop&crop=entropy&fm=webp&auto=format,compress)
