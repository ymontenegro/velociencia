---
title: "Drift cardíaco en ciclismo: por qué la frecuencia cardíaca sube cuando la potencia no"
subtitle: "En 60 minutos de zona 2, la frecuencia cardíaca puede subir entre 5 y 15 pulsaciones sin que la potencia varíe. El mecanismo es cardiovascular, termorregulador y, en parte, evitable"
section: "ciencia"
date: "2026-05-19"
author: "Sofía Müller"
tags: ["drift cardíaco", "frecuencia cardíaca", "cardiovascular drift", "zona 2", "hidratación", "aerobic decoupling", "durabilidad", "termorregulación"]
sources:
...
<ChartLine
  title="Evolución típica de FC y potencia durante 60 min en Z2 (calor moderado)"
  caption="Patrón esquemático basado en Coyle & González-Alonso (2001) y González-Alonso et al. (1997)"
  data={[
    { x: "0 min", fc: 130, potencia: 195 },
    { x: "10 min", fc: 132, potencia: 195 },
    { x: "20 min", fc: 135, potencia: 195 },
    { x: "30 min", fc: 138, potencia: 194 },
    { x: "40 min", fc: 141, potencia: 194 },
    { x: "50 min", fc: 144, potencia: 193 },
    { x: "60 min", fc: 147, potencia: 193 }
  ]}
  xKey="x"
  lines={[
    { key: "fc", color: "#7C3AED", name: "FC (ppm)" },
    { key: "potencia", color: "#0891B2", name: "Potencia (W)" }
  ]}
  unit=""
/>
...
<ChartBar
  title="Drift de FC en 60 min según temperatura e hidratación"
  caption="Estimaciones basadas en González-Alonso et al. (1997, 1998) y Coyle & González-Alonso (2001)"
  data={[
    { condicion: "Fresco + hidratado", drift: 4 },
    { condicion: "Calor + hidratado", drift: 8 },
    { condicion: "Fresco + deshidratado", drift: 7 },
    { condicion: "Calor + deshidratado", drift: 14 }
  ]}
  xKey="condicion"
  bars={[{ key: "drift", color: "#7C3AED", name: "Aumento de FC (ppm en 60 min)" }]}
  layout="vertical"
  unit=" ppm"
/>
