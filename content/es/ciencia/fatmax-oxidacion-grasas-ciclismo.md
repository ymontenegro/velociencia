---
title: "FatMax: La Intensidad Donde el Músculo Quema Más Grasa"
subtitle: "Existe un punto exacto en la curva de intensidad donde la oxidación de grasas alcanza su pico. Ese punto —el FatMax— no es el reposo ni el esfuerzo máximo, sino una zona intermedia que el entrenamiento puede desplazar hacia arriba. Entenderlo cambia cómo se planifica la base aeróbica."
section: "ciencia"
date: "2026-05-13"
author: "Sofía Müller"
tags: ["FatMax", "oxidación de grasas", "zona 2", "calorimetría indirecta", "MFO", "metabolismo", "entrenamiento aeróbico", "durabilidad"]
excerpt: "FatMax es la intensidad de ejercicio a la que la tasa de oxidación de grasas alcanza su valor máximo (MFO). En ciclistas entrenados, esta intensidad equivale al 59-64% del VO₂max y produce entre 0.5 y 1.0 g/min de oxidación lipídica. El entrenamiento aeróbico y la dieta pueden desplazar ese pico hacia intensidades más altas, mejorando la eficiencia metabólica y la durabilidad en carrera."
...
<ChartLine
  title="Curva de oxidación de sustratos según intensidad (% VO₂max)"
  caption="Basado en datos medios de Achten et al. (2002) y Venables et al. (2005). El cruce de curvas muestra el FatMax."
  data={[
    { pct: "40%", grasas: 0.28, carbohidratos: 0.72 },
    { pct: "50%", grasas: 0.42, carbohidratos: 1.15 },
    { pct: "60%", grasas: 0.50, carbohidratos: 1.68 },
    { pct: "65%", grasas: 0.49, carbohidratos: 2.10 },
    { pct: "70%", grasas: 0.41, carbohidratos: 2.85 },
    { pct: "80%", grasas: 0.24, carbohidratos: 3.90 },
    { pct: "90%", grasas: 0.08, carbohidratos: 5.20 }
  ]}
  xKey="pct"
  lines={[
    { key: "grasas", color: "#7C3AED", name: "Oxidación grasas (g/min)" },
    { key: "carbohidratos", color: "#0891B2", name: "Oxidación carbohidratos (g/min)" }
  ]}
  unit=" g/min"
/>
...
<ChartBar
  title="MFO por nivel de entrenamiento (g/min)"
  caption="Valores medios según Venables et al. (2005) y Maunder et al. (2018). La variabilidad individual es elevada."
  data={[
    { nivel: "Sedentario", mfo: 0.18 },
    { nivel: "Recreativo", mfo: 0.30 },
    { nivel: "Entrenado aficionado", mfo: 0.47 },
    { nivel: "Competidor regional", mfo: 0.62 },
    { nivel: "Elite profesional", mfo: 0.85 }
  ]}
  xKey="nivel"
...
Fuentes:
- [Determination of the exercise intensity that elicits maximal fat oxidation](https://pubmed.ncbi.nlm.nih.gov/11782653/)
- [Maximal fat oxidation during exercise in trained men](https://pubmed.ncbi.nlm.nih.gov/14598198/)
- [Optimizing fat oxidation through exercise and diet](https://pubmed.ncbi.nlm.nih.gov/15212756/)
- [Determinants of fat oxidation during exercise in healthy men and women](https://pubmed.ncbi.nlm.nih.gov/15333616/)
- [Assessment of Metabolic Flexibility by Means of Measuring Blood Lactate, Fat, and Carbohydrate Oxidation](https://pubmed.ncbi.nlm.nih.gov/28623613/)
- [Contextualising Maximal Fat Oxidation During Exercise: Determinants and Normative Values](https://pubmed.ncbi.nlm.nih.gov/29875697/)
- [Peak fat oxidation is positively associated with vastus lateralis CD36 content](https://pubmed.ncbi.nlm.nih.gov/34562114/)
