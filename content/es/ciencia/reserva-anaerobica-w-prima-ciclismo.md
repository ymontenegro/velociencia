---
title: "W': La Reserva Anaeróbica Que Decide los Ataques de Carrera"
subtitle: "El modelo de Potencia Crítica divide el esfuerzo en dos zonas: lo que el aeróbico puede sostener indefinidamente y la batería de energía anaeróbica que se agota con cada ataque. Entender W' cambia cómo se leen las carreras y cómo se entrena."
section: "ciencia"
date: "2026-05-11"
author: "Sofía Müller"
tags: ["W prime", "potencia crítica", "fisiología", "anaerobic work capacity", "W balance", "ciclismo de carrera", "HIIT", "potencia"]
excerpt: "W' (W-prima) es la reserva finita de trabajo anaeróbico disponible por encima de la Potencia Crítica. En ciclistas entrenados oscila entre 10 y 30 kJ, se agota con cada ataque y se recarga parcialmente en recuperación. Conocerla permite planificar cuántos contraataques puede dar un corredor antes de vaciarse."
...
<ChartLine
  title="Tiempo hasta agotamiento según potencia sobre CP (modelo W')"
  caption="Simulación para W' = 20 kJ. A mayor diferencia entre potencia aplicada y CP, menor tiempo disponible."
  data={[
  ...
  xKey="delta"
  lines={[
    { key: "tiempo", color: "#7C3AED", name: "Segundos hasta agotamiento" }
  ]}
  unit=" s"
/>
...
<ChartBar
  title="Valores de W' por nivel de ciclista (referencia de literatura)"
  caption="Valores orientativos compilados de estudios publicados. La CP varía más entre niveles que la W'."
  data={[
    { nivel: "Recreativo", wprime: 12 },
    { nivel: "Entrenado aficionado", wprime: 18 },
    { nivel: "Competidor regional", wprime: 22 },
    { nivel: "Elite nacional", wprime: 25 },
    { nivel: "Profesional WorldTour", wprime: 28 }
  ]}
  xKey="nivel"
  bars={[{ key: "wprime", color: "#7C3AED", name: "W' estimada (kJ)" }]}
  unit=" kJ"
  layout="vertical"
/>
...
Fuentes:
- [Determination of critical power using a 3-min all-out cycling test](https://pubmed.ncbi.nlm.nih.gov/17473782/)
- [A 3-min all-out cycling test is sensitive to a change in critical power](https://pubmed.ncbi.nlm.nih.gov/18685519/)
- [Critical power: implications for determination of VO2max and exercise tolerance](https://pubmed.ncbi.nlm.nih.gov/20195180/)
- [Modeling the expenditure and reconstitution of work capacity above critical power](https://pubmed.ncbi.nlm.nih.gov/22382171/)
- [Validation of a novel intermittent W' model for cycling using field data](https://pubmed.ncbi.nlm.nih.gov/24509723/)
- [Critical Power: An Important Fatigue Threshold in Exercise Physiology](https://pubmed.ncbi.nlm.nih.gov/27031742/)
