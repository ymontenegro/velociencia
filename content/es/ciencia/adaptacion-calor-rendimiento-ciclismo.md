---
title: "Adaptación al Calor: Cómo el Heat Acclimation Mejora el Rendimiento Ciclista"
subtitle: "Diez días de entrenamiento en calor mejoran la contrarreloj un 6% incluso en condiciones frescas, gracias a la expansión del volumen plasmático"
section: "ciencia"
date: "2026-04-03"
author: "Sofía Müller"
tags: ["calor", "heat acclimation", "termorregulación", "volumen plasmático", "rendimiento"]
sources:
...
<ChartBar
  title="Mejora del rendimiento tras 10 días de heat acclimation"
  caption="Fuente: Lorenzo et al. (2010), J Appl Physiol"
  data={[
    { parametro: "TT en frío", mejora: 6 },
    { parametro: "TT en calor", mejora: 8 },
    { parametro: "VO₂max frío", mejora: 5 },
    { parametro: "VO₂max calor", mejora: 8 },
    { parametro: "Umbral lactato", mejora: 5 },
    { parametro: "Vol. plasmático", mejora: 6.5 }
  ]}
  xKey="parametro"
...
<ChartLine
  title="Tiempo en contrarreloj de 43.4 km según aclimatación"
  caption="Fuente: Racinais et al. (2015), Med Sci Sports Exerc"
  data={[
    { x: "Día 1 (calor)", tiempo: 77 },
    { x: "Día 6 (calor)", tiempo: 69 },
    { x: "Día 14 (calor)", tiempo: 66 },
    { x: "Frío (post)", tiempo: 66 }
  ]}
  xKey="x"
  lines={[
    { key: "tiempo", color: "#7C3AED", name: "Tiempo (min)" }
  ]}
  unit=" min"
/>
