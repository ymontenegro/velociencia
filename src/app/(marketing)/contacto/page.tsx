        ...
        <div className="bg-[var(--color-text)] dark:bg-[#0A0A0E]">
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
            <div className="flex items-center gap-2.5">
              ...
              <span className="inline-block rounded-full bg-white/20 px-3 py-1 font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-white backdrop-blur-sm">Contact</span>
            </div>
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2">
            <div>
              <div className="border-t-[6px] border-[var(--color-text)] pt-4">
                <h2 className="font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-[var(--color-text-muted)]">Email</h2>
              </div>
            ...
            <div>
              <div className="border-t-[6px] border-[var(--color-text)] pt-4">
                <h2 className="font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-[var(--color-text-muted)]">Collaborations</h2>
              </div>
          ...
          <div className="mt-16 border-t border-[var(--color-border)] pt-12">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-[var(--color-text-muted)]">About this project</p>
    ...
    <div>
      <div className="bg-[var(--color-text)] dark:bg-[#0A0A0E]">
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="flex items-center gap-2.5">
            <span className="tool-live-dot inline-block h-1.5 w-1.5 rounded-full bg-white/60" aria-hidden="true" />
            <span className="inline-block rounded-full bg-white/20 px-3 py-1 font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-white backdrop-blur-sm">Contacto</span>
          </div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2">
          <div>
            <div className="border-t-[6px] border-[var(--color-text)] pt-4">
              <h2 className="font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-[var(--color-text-muted)]">Correo electrónico</h2>
            </div>
          ...
          <div>
            <div className="border-t-[6px] border-[var(--color-text)] pt-4">
              <h2 className="font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-[var(--color-text-muted)]">Colaboraciones</h2>
            </div>
        ...
        <div className="mt-16 border-t border-[var(--color-border)] pt-12">
          <div className="flex items-start gap-4">
            <div className="mt-0.5 h-8 w-[2px] flex-shrink-0 bg-[var(--color-border)]" />
            <div>
              <p className="font-mono text-[9px] font-medium uppercase tracking-[0.22em] text-[var(--color-text-muted)]">Sobre este proyecto</p>
